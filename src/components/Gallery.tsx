  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={!!selectedImage} onOpenChange={() => setSelectedImage(null)}>
        <DialogContent className="max-w-5xl sm:max-w-[90vw] md:max-w-5xl w-full p-0 overflow-hidden rounded-[2.5rem] border-none bg-slate-950/98 backdrop-blur-3xl shadow-2xl" dir="rtl">
          {selectedImage && (
            <div className="relative flex flex-col h-auto max-h-[90vh] overflow-y-auto">
               {/* Main Content Area: Image + Sidebar */}
               <div className="flex flex-col md:flex-row items-center justify-between p-6 md:p-8 gap-6 md:gap-8 overflow-hidden min-h-[300px] md:min-h-[400px]">
                  {/* Image Container */}
                  <div className="flex-1 w-full h-[35vh] sm:h-[45vh] md:h-[60vh] flex items-center justify-center overflow-hidden bg-white/5 rounded-3xl border border-white/10 shadow-2xl group relative">
                    <Button 
                      variant="ghost" 
                      size="icon" 
               ...
               <div className="p-6 md:p-10 bg-gradient-to-t from-black to-black/80 backdrop-blur-3xl border-t border-white/10 mt-auto">
